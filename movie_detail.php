...
<body>
    ...
    <nav>
        <ul class="nav" style="width: 100%;">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="discussion.php">DISSCUSSION</a>
            </li>
    ...
    <section class="container">       
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6">
                    <img class="card-img-top mb-5 mb-md-0" src="<?php echo $movie['poster_url']; ?>" alt="<?php echo $movie['name']; ?>" />
                </div>
                <div class="col-md-6">
                    <h1 class="display-5 fw-bolder"><?php echo $movie['name']; ?></h1>
                    <div class="fs-5 mb-5">
                        <span class="text-decoration-line-through">Directed by: <?php echo $movie['director']; ?></span>
                    </div>
                    <div class="fs-5 mb-5">
                        <span class="text-decoration-line-through">Released in: <?php echo $movie['release_year']; ?></span>
                    </div>
                    <p class="lead"><?php echo $movie['synopsis']; ?></p>
                    <div class="d-flex">
                    ...
                    <div class="card">
                        <div class="row d-flex">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div>
                                    <p class="text-left"><span class="text-mutedpt"><?php echo $rating['star_rating']; ?> Stars</span></p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        function checkLogin(movie_id) {
            // Check if the user is logged in by verifying if a session variable 'user_id' is set
            <?php if (!isset($_SESSION['user_id'])): ?>
